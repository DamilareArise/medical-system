...
urlpatterns = [
    ...
    re_path(r'^book_service/(?P<serv_id>\d+)/',serv_views.book_service,name='book_service'),
    re_path(r'^booking_record/(?P<userid>\d+)/',serv_views.booking_record,name='booking_record'),
]